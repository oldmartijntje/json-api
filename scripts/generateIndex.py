...
defaultComment = '<!-- Generated by OldMartijntje\'s Static API -->'
done = 0
...
def saveHTML(header, content, filePath, files, folders):
    ...
    analytics = '''
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-6GKK0CV8WD"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-6GKK0CV8WD');
    </script>
'''
...
'''
    ...
    try:
        with open(filePath + indexName, 'r') as file:
            if defaultComment not in file.readline():
                indexAutoGenerated = False
            file.close()
    except:
        indexAutoGenerated = True
    ...
    with open(filePath + indexName, 'w') as file:
